        ...
        <div class="mail-box">
            <aside class="sm-side">
                ...
                <ul class="inbox-nav inbox-divider">
                    ...
                    <li>
                        <a href="{{url('generaboletin/enviarboletin')}}"><i class="fa fa-envelope-o"></i> Enviar Boletín</a>
                    </li>
                    <li>
            ...
            <aside class="lg-side">
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{url('generaboletin/enviarboletin')}}">
                    {!! method_field('PUT') !!}
                    {!! csrf_field() !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="mensaje" value="{{ old('mensaje') }}">
